...
define("dummy/tests/integration/components/x-tab-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | x tab', function (hooks) {
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              */
              {
                id: "eR4NArzW",
                block: "{\"symbols\":[\"tab\"],\"statements\":[[0,\"\\n\"],[4,\"x-tab\",null,null,{\"statements\":[[4,\"x-tab/navigation\",null,null,{\"statements\":[[4,\"x-tab/nav-wrap\",null,[[\"paneId\",\"tab\"],[\"home\",[24,1,[]]]],{\"statements\":[[0,\"          \"],[7,\"i\"],[11,\"class\",\"icon icon-home\"],[9],[10],[0,\"\\n          \"],[7,\"span\"],[9],[0,\"Home\"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"x-tab/nav-wrap\",null,[[\"paneId\",\"tab\"],[\"archive\",[24,1,[]]]],{\"statements\":[[0,\"          \"],[7,\"i\"],[11,\"class\",\"icon icon-box\"],[9],[10],[0,\"\\n          \"],[7,\"span\"],[9],[0,\"Archive\"],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"\\n\"],[0,\"      \"],[7,\"div\"],[11,\"class\",\"content-wrap\"],[9],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,1,[\"pane\"]],\"expected `tab.pane` to be a contextual component but found a string. Did you mean `(component tab.pane)`? (L17:C11) \"],null]],[[\"elementId\"],[\"home\"]],{\"statements\":[[0,\"          \"],[7,\"h1\"],[9],[0,\"Home\"],[10],[0,\"\\n          \"],[7,\"p\"],[9],[0,\"This is home content\"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,1,[\"pane\"]],\"expected `tab.pane` to be a contextual component but found a string. Did you mean `(component tab.pane)`? (L22:C11) \"],null]],[[\"elementId\"],[\"archive\"]],{\"statements\":[[0,\"          \"],[7,\"h1\"],[9],[0,\"Archive\"],[10],[0,\"\\n          \"],[7,\"p\"],[9],[0,\"This is archive content\"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"      \"],[10],[0,\"\\n      \"],[7,\"div\"],[11,\"id\",\"activeId\"],[9],[1,[24,1,[\"activeId\"]],false],[10],[0,\"\\n      \"],[7,\"div\"],[11,\"id\",\"switch\"],[12,\"onclick\",[29,\"action\",[[24,0,[]],[24,1,[\"selectAction\"]],\"archive\"],null]],[9],[10],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"  \"]],\"hasEval\":false}",
                meta: {}
              }));
    ...
    function assertActiveTab(assert, tabIndex) {
      ...
      if ((0, _testHelpers.findAll)('nav > ul >  li').length > 0) {
        assert.equal(this.element.querySelector("nav > ul >  li:nth-child(".concat(tabIndex + 1, ")")).classList.contains('tab-current'), active, active ? 'tab is active' : 'tab is inactive');
      }

      assert.equal(this.element.querySelector(".content-wrap section:nth-child(".concat(tabIndex + 1, ")")).classList.contains('content-current'), active, active ? 'tab pane is active' : 'tab pane is inactive');
    }
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                assert.dom('section').exists({
                  count: 2
                }, 'yields tab pane component');
                _context2.next = 3;
                return (0, _testHelpers.click)('#switch');
    ...
    (0, _qunit.test)('it generates tab navigation', function (assert) {
      ...
      assert.dom('nav > ul >  li').exists({
        count: 2
      }, 'has tabs navigation items');
...
define("dummy/tests/integration/components/x-tab/nav-item-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | x tab/nav item', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', /*#__PURE__*/function () {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                */
                {
                  id: "NiFRzjF/",
                  block: "{\"symbols\":[],\"statements\":[[1,[29,\"x-tab/nav-item\",null,[[\"selectAction\"],[[29,\"action\",[[24,0,[]],[25,[\"externalAction\"]]],null]]]],false]],\"hasEval\":false}",
                  meta: {}
                }));
              ...
              case 3:
                ...
                */
                {
                  id: "Cob7SMSC",
                  block: "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"x-tab/nav-item\",null,[[\"selectAction\"],[[29,\"action\",[[24,0,[]],[25,[\"externalAction\"]]],null]]],{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
                  meta: {}
                }));
...
define("dummy/tests/integration/components/x-tab/nav-wrap-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | x tab/nav wrap', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(assert) {
        var tab;
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                */
                {
                  id: "xu+y3cpe",
                  block: "{\"symbols\":[],\"statements\":[[1,[29,\"x-tab/nav-wrap\",null,[[\"tab\"],[[25,[\"tab\"]]]]],false]],\"hasEval\":false}",
                  meta: {}
                }));
              ...
              case 4:
                ...
                */
                {
                  id: "E2Knr9Fj",
                  block: "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"x-tab/nav-wrap\",null,[[\"tab\"],[[25,[\"tab\"]]]],{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
                  meta: {}
                }));
...
define("dummy/tests/integration/components/x-tab/navigation-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | x tab/navigation', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(assert) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                */
                {
                  id: "iIVLWFgy",
                  block: "{\"symbols\":[],\"statements\":[[1,[23,\"x-tab/navigation\"],false]],\"hasEval\":false}",
                  meta: {}
                }));
              ...
              case 2:
                ...
                */
                {
                  id: "ZduO2DaI",
                  block: "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"x-tab/navigation\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
                  meta: {}
                }));
...
define("dummy/tests/integration/components/x-tab/pane-test", ["qunit", "ember-qunit", "@ember/test-helpers"], function (_qunit, _emberQunit, _testHelpers) {
  "use strict";
  ...
  (0, _qunit.module)('Integration | Component | x tab/pane', function (hooks) {
    (0, _emberQunit.setupRenderingTest)(hooks);
    (0, _qunit.test)('it renders', /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(assert) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                */
                {
                  id: "mzBk66Je",
                  block: "{\"symbols\":[],\"statements\":[[1,[23,\"x-tab/pane\"],false]],\"hasEval\":false}",
                  meta: {}
                }));
              ...
              case 2:
                ...
                */
                {
                  id: "ggvLdh7f",
                  block: "{\"symbols\":[],\"statements\":[[0,\"\\n\"],[4,\"x-tab/pane\",null,null,{\"statements\":[[0,\"        template block text\\n\"]],\"parameters\":[]},null],[0,\"    \"]],\"hasEval\":false}",
                  meta: {}
                }));
...
define("dummy/tests/lint/tests.lint-test", [], function () {
  ...
  QUnit.test('integration/components/x-tab-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/x-tab-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/x-tab/nav-item-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/x-tab/nav-item-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/x-tab/nav-wrap-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/x-tab/nav-wrap-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/x-tab/navigation-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'integration/components/x-tab/navigation-test.js should pass ESLint\n\n');
  });
  QUnit.test('integration/components/x-tab/pane-test.js', function (assert) {
    assert.expect(1);
